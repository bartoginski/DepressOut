  ...
  <SectionWrapper>
    ...
    <template #content>
      <p>
        ...
        nierozpoznana, a spośród osób z rozpoznaną depresją jedynie połowa
        otrzymuje adekwatne leczenie. Z tego względu niezwykle ważną dla każdego
        (nie tylko dla lekarza) kwestią jest znajomość natury i objawów depresji
        oraz podstaw jej diagnostyki i leczenia.
      </p>
      <p>
        Według Światowej Organizacji Zdrowia (WHO) depresja jest wiodącą
        przyczyną niesprawności i niezdolności do pracy na świecie oraz
